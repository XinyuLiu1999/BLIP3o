...
LR=5e-5
RUN_NAME="Pretrain-0408-original-caption-25M"
...
torchrun \
    ...
    --data_dir /backup/user/liuxinyu/BLIP3o-Pretrain-Long-Caption \
    --data_cache_dir /backup/user/liuxinyu/.cache \
    --data_arrow_dir /backup/user/liuxinyu/.cache/webdataset/default-0dfe83a2a8819c35/0.0.0/b802d95c473c6c5bd395aae2b78ce3bd599a784d43c7d164510277fdc676c1f8 \
    --caption_key txt \
    ...
    --resume_from_checkpoint ${LOCAL_DIR}/checkpoint-90000
